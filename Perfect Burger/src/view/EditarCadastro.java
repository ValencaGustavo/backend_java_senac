...
public class EditarCadastro extends JFrame {
    ...
    private final String dbPadrao = "db_perfect_burger";
    private final String tblPadrao = "tbl_perfect_burger";
