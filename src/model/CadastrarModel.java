...
import java.sql.*;
    ...
    public static boolean cadastrarUsuario(String login) {
        ...
        String nome = NovoCadastroView.usuarioJTextField.getText();
        String email = NovoCadastroView.emailJTextField.getText();
        String senha = NovoCadastroView.senhaJPasswordField.getText();
        ...
        try {
            ...
            if (rstPesquisarEmail.next()) {
                NovoCadastroView.notificacaoJLabel.setText("Ops! Parece que há um cadastro com esse email. Por favor, verifique e tente novamente com outro email.");
            } else {
            ...
            ex.printStackTrace();
            NovoCadastroView.notificacaoJLabel.setText("Ocorreu um erro ao cadastrar. Por favor, tente novamente.");
        }
    } else {
        NovoCadastroView.notificacaoJLabel.setText("Você deve aceitar os termos para cadastrar-se.");
    }
}